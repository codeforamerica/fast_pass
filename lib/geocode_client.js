...
var PATH   = '/clvgis/rest/services/LASVEGAS_Address_Locator/GeocodeClient'
var PORT   = 80
var METHOD = 'POST'

var GeocodeClient  = {};

GeocodeClient.geocodeAddress = function (address, cb) {
...
GeocodeClient.reverseGeocode = function (point, cb) {

  point.toESRI102707();

  var path = '/clvgis/rest/services/CCParcel_Address_Locator/GeocodeClient/';
...
GeocodeClient.findAddressCandidates = function (address, cb) {
